    ...
    return (
      <div className={resetView}>
        <div className={resetFormContainer}>
          <SuccessBlock className={resetSuccess}>You've successfully reset your password!</SuccessBlock>
      ...
      <div className={resetView}>
        <div className={resetFormContainer}>
          ...
          >
            ...
            <Button block primary type="submit">Change Password</Button>
          </form>
        </div>
      </div>
    );
...
)(redirectIfLoggedIn(ResetPassword));
